...
const styles = StyleSheet.create({
  ...
  button: { backgroundColor: '#1D9E75', width: width - 56, paddingVertical: 24, borderRadius: 100, alignItems: 'center' },
  buttonText: { color: 'white', fontSize: 22, fontWeight: '700', letterSpacing: 0.5 },
